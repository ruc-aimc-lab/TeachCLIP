CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port=12226 \
    ...
    --train_csv ["datasets/msrvtt_data/MSRVTT_train.7k.csv"] \
    --val_csv ["datasets/msrvtt_data/MSRVTT_full_split_val.csv"] \
    --test_csv ["datasets/msrvtt_data/MSRVTT_full_split_test.csv"] \
